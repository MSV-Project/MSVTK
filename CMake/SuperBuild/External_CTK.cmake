...
if(NOT DEFINED CTK_DIR)
  ...
  ExternalProject_Add(${proj}
    ...
    CMAKE_ARGS
      ...
      -DCTK_INSTALL_LIB_DIR:STRING=${MSVTK_INSTALL_BIN_DIR}
      ...
      -DCTK_CMAKE_RUNTIME_OUTPUT_DIRECTORY:STRING=${MSVTK_BINARY_DIR}/MSVTK-build/bin
      -DCTK_CMAKE_LIBRARY_OUTPUT_DIRECTORY:STRING=${MSVTK_BINARY_DIR}/MSVTK-build/bin
      -DCTK_CMAKE_ARCHIVE_OUTPUT_DIRECTORY:STRING=${MSVTK_BINARY_DIR}/MSVTK-build/bin
    INSTALL_COMMAND ""
    DEPENDS
      ${CTK_DEPENDENCIES}
    )
